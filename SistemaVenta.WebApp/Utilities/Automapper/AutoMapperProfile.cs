...
namespace SistemaVenta.WebApp.Utilities.Automapper
{
        ...
        public AutoMapperProfile()
        {
            ...
            CreateMap<Negocio, VMNegocio>()
                .ForMember(destino =>
                    ...
                    opt => opt.MapFrom(origen => Convert.ToString(origen.PorcentajeImpuesto, new CultureInfo("es-AR")))
            );
            ...
            CreateMap<VMCategoria, Categoria>()
                .ForMember(destino =>
                destino.EsActivo,
                opt => opt.MapFrom(origen => origen.EsActivo == 1 ? false : true)
                );
